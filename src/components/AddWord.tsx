        ...
        <div>
          <div className="flex h-[89px] w-[1092px] gap-2">
            <div className="mb-2 h-[89px] w-[540px] rounded-xl border bg-white pl-5 hover:border-global_blue">
              ...
              />
              {errors.word && (
                <p className="text-red-500">{errors.word.message}</p>
              )}
            </div>
            <div className="mb-2 h-[89px] w-[540px] rounded-xl border bg-white pl-5 hover:border-global_blue">
          ...
          <div className="my-3 h-[89px] w-[1092px] rounded-xl border bg-white pl-5 hover:border-global_blue">
            ...
            <div className="flex items-center gap-3">
              ...
              {errors.pronunciation && (
                <p className="text-red-500">{errors.pronunciation.message}</p>
              )}
            </div>
          </div>

          {partsOfSpeech.map((part, index) => (
            <div className="mb-2 h-auto w-[1092px] rounded-xl border border-lightGrey bg-white pl-5 hover:border-global_blue">
              <div className="mb-5">
                ...
                <div className="mx-4 rounded-xl border border-textGrey p-2">
                  ...
                  <div className="mt-6 rounded bg-lightGrey p-3">
                    <div className="mb-3">
                    ...
                    <div className="mb-3 flex justify-between">
                      <div>
                        ...
                        {examples.map((example, index) => (
                          <div
                            key={index}
                            className="ml-16 mt-2 flex items-center"
                          >
                  ...
                  {showAdditionalFields && (
                    <div className="mt-5 bg-lightGrey p-2">
                      <div className="mb-3">
                        <label className="text-textGrey">Meaning : </label>
                        <div className="ml-16 flex items-center">
