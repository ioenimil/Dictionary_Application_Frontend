  ...
  return (
    <div className="flex h-8 w-[326px] items-center justify-between gap-26 md:h-tabletHeight md:w-[689px] lg:w-[736.99px]">
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        <div ref={modalRef}>
          <h2 className="text-textGrey mb-4 text-center text-3xl font-medium">
            Log In
          </h2>
          <form className="text-textGrey">
            ...
            <div className="mb-5 flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="mr-2 text-textGrey  rounded-full text-sm font-medium custom-checkbox" />
                Remember Me
              </label>
